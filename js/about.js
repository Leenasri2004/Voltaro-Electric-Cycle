...
if (rtlBtn) {
  rtlBtn.addEventListener("click", () => {
    ...
    if (isRTL) {
      document.body.removeAttribute("dir");         // back to LTR
      document.body.classList.remove("rtl-about");
    } else {
      document.body.setAttribute("dir", "rtl");     // enable RTL
      document.body.classList.add("rtl-about");
    }
  });
}
